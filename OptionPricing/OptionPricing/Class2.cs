    ...
    public class Output
    {
        ...
        public void Output_Calculation(double S, double K, double r, double T, double sigma, int N, double div)
        {
            ...
            if (IsEuropean == true)
            {
                ...
                if (IsCall == true)
                {
                    Console.WriteLine("The Underlying Prices Trinomial Tree is showed:");
                    ...
                    Console.WriteLine();
                    Console.WriteLine("The Option Value Trinomial Tree is showed:");
                    ...
                    Console.WriteLine("The European Call Option Price is" + "  " + Vt[0, 0].ToString());
                    Console.WriteLine();

                    // Output Greeks
                    Console.WriteLine("The Greeks of this option are showed:");
                    greeks.St = St;
                    greeks.Vt = Vt;
                ...
                else
                {
                    ...
                    // Output option price.
                    Console.WriteLine("The European Put Option Price is" + "  " + Vt[0, 0].ToString());
                    Console.WriteLine();
            ...
            else
            {
                ...
                if (IsCall == true)
                {
                    ...
                    Console.WriteLine("The American Call Option Price is" + "  " + Vt[0, 0].ToString());
                    Console.WriteLine();
                ...
                else
                {
                    ...
                    // Output American call option price
                    Console.WriteLine("The American Put Option Price is" + "  " + Vt[0, 0].ToString());
                    Console.WriteLine();
